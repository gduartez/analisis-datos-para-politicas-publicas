...
[^c0_instr-1]: Recientemente POSIT lanzó otro IDE llamado *Positron*. Si bien su lanzamiento ya dejó de estar en una versión beta, para personas que recien se inician en la programación puede resultar un poco abrumadora su interfaz. No obstante, puede ser muy útil para quienes manejen otros lenguajes de programación y busquen un IDE optimizado para la ciencia de datos. Para más información ver: <https://positron.posit.co/welcome.html>
...
![Inicio de Rstudio](images/rstudio_console.png)
